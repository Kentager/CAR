//TODO: ABLE TO DISABLE CALIBRATION UPDATE MORE EFFICIENT
//TODO: CHANGE AVERAGE DUE TO NEW EXTREME FOUND
#include "CalibrateMagneto.h"

/**
 * @brief 构造函数，用于初始化磁场校准对象
 * 
 * 该构造函数初始化测量编号为0，并设置绝对增益和相对增益的初始值。
 */
