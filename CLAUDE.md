...
- 姿态/里程检测：
  - mpu6050+hmc5883l (三轴加速度+三轴陀螺仪+磁力计)：采用**卡尔曼滤波**实现姿态解算（偏航角/俯仰角/横滚角）
...
- 运动控制：
  ...
  - mpu6050+hmc5883l卡尔曼滤波解算偏航角，实时修正行驶偏航，结合编码器做二次校准
...
- 定时器分配（四路电机专属）：
  ...
  - 辅助定时器：
    ...
    - TIM7：mpu6050+hmc5883l数据读取 (10ms周期，100Hz，TIM_IT_Update中断)，触发卡尔曼滤波计算
